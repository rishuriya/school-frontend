      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4">Bright Future Academy</h3>
            <p className="text-gray-300 mb-4">
              Empowering minds and building futures through excellence in education, 
              character development, and innovative learning approaches.
            </p>
            <div className="space-y-2 text-sm text-gray-300">
              <p>📍 {contactInfo?.address || '123 Education Street, Knowledge City, KC 12345'}</p>
              <p>📞 {contactInfo?.phone || '+1 (555) 123-4567'}</p>
              <p>✉️ {contactInfo?.email || 'info@brightfutureacademy.edu'}</p>
            </div>
          </div>
