        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/programs" className="text-gray-300 hover:text-white transition-colors">Academic Programs</Link>
              </li>
              <li>
                <Link href="/students/notices" className="text-gray-300 hover:text-white transition-colors">Notices</Link>
              </li>
              <li>
                <Link href="/events" className="text-gray-300 hover:text-white transition-colors">Events</Link>
              </li>
              <li>
                <Link href="/facilities" className="text-gray-300 hover:text-white transition-colors">Facilities</Link>
              </li>
              <li>
            ...
            <div className="flex flex-wrap gap-4">
              {socialMedia?.map((social, index) => (
                <a
                  ...
                  className="text-gray-300 hover:text-white transition-colors p-2 bg-white/5 rounded-full hover:bg-white/10"
              ...
              {(!socialMedia || socialMedia.length === 0) && (
                <p className="text-sm text-gray-400 italic">Follow us on our social platforms</p>
              )}
            </div>
          </div>
        </div>
